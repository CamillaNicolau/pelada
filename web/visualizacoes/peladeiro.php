<div class=" container-content col flex-grow-1 mw-100 p-0 bg-secondary ">
            ...
            <fieldset>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-12 col-lg-6">
                        ...
                        <input id="telPeladeiro" name="telPeladeiro" class="form-control" required="" placeholder="(xx)xxxxx-xxxx" type="tel">
                    </div>   
                </div>
                <div class="form-row">
                    <div class="form-group col-sm-12 col-lg-6">
                    ...
                    <div class="form-group col-sm-12 col-lg-6 d-flex flex-column">
                        ...
                        <div class="btn-group" data-toggle="buttons"> 
                            ...
                            <label class="btn btn-secondary w-50" >
                                <input type="radio" name="participacao" id="diarista" value="diarista" checked="checked"> Diarista
                            </label>
                        </div>
                    </div>
                </div>
    ...
    <span class="busca-peladeiro col-12" style="display: none">
        <h2 class="box-subtitle"><strong>ENCONTRE O PELADEIRO</strong></h2>
        <div class="alert alert-info" role="alert">
            <strong>Olá,</strong> informe um email para encontrar o peladeiro.
        </div>
        <div class="input-group col-12 col-md-6 p-0 mb-3">
            <input class="form-control" type="search" id="busca" name="busca" placeholder="Informe o e-mail">
            <button class="btn btn-info col-3 col-md-2 p-0" type="submit"  id="encontra-peladeiro"><i class="fas fa-search"></i></button>
        </div>
