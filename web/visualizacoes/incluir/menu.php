...
<html lang="pt-br">
   ...
   <!--    <link type="text/css" href="./visualizacoes/css/geral.css" rel="stylesheet" />
    ...
    <body>
              ...
              <div class="container">
      <div class="full-row row-header">
        <div class="header row middle-xs between-xs">
          <!--<img src="./visualizacoes/imagens/logo.jpg" alt="futebol">;-->
          <div class="logo col-xs-3">
              <a href="inicio" >
                <img src="./visualizacoes/imagens/logo.jpg" alt="mais pelada">
            </a>
          </div>
          <nav class="menu-principal col-xs-9">
            <ul>
              <li><a  href="pelada"><i class="far fa-futbol"></i> Pelada</a></li>
